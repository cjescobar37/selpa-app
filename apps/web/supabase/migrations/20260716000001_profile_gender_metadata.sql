...
begin
  ...
  insert into public.profiles (user_id, id, email, first_name, last_name, display_name, gender)
  values (new.id, new.id, new.email, v_first_name, v_last_name, v_display_name, v_gender)
