...
export async function POST(req:NextRequest,context:Context){
  ...
  const operation={SCHEDULE:['schedule_competition_series',base],RETURN_TO_DRAFT:['return_competition_series_to_draft',base],ACTIVATE:['activate_competition_series',{...base,p_confirm:v.confirm}],CLOSE:['close_competition_series',base],CANCEL:['cancel_competition_series',{...base,p_reason:v.reason}],ARCHIVE:['archive_competition_series',base]}[v.action] as [string,Record<string,unknown>]
