    ...
    <PlayerSpaceLayout><main className="playerRankShell">
      ...
      {!session.activeClub?.id ? (
        ...
        <>
          ...
          <div className="playerRankActions">
            ...
            <Link href="/player/ranking/club/todos?view=pairs">Ver ranking de parejas</Link>
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          .playerRankContextRow { border-radius:12px; gap:7px; grid-template-columns:30px 44px minmax(0,1fr) 72px; min-height:56px; padding:5px 6px; }
          .playerRankContextPlace { font-size:15px; }
          .playerRankContextRow .playerRankAvatar { height:44px; width:44px; }
          .playerRankContextRow b { overflow: visible; text-overflow: clip; white-space: normal; }
          .playerRankContextRow span { font-size:11px; font-weight:850; line-height:1.15; }
          .playerRankContextRow em { display: none; }
          .playerRankContextRow i { font-size:13px; grid-column:4; grid-row:1; justify-self:end; min-width:0; text-align:right; white-space:nowrap; }
        }
      `}</style>
