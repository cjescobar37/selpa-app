...
export default function AppNavbarClient() {
  ...
  // Solo recargar notificaciones cuando cambia el usuario o el estado de auth,
  // NO en cada cambio de pathname (eso causaba re-compilaciones en cada navegación)
  useEffect(() => {
    let alive = true
    ;(async () => {
      if (!alive) return
